  ...
  std::shared_ptr<nav2_costmap_2d::Costmap2DROS> costmap_ros)
{
  ...
  declare_parameter_if_not_declared(node.get(), name + ".max_angular_accel",
  ...
  nav2_core::GoalChecker * goal_checker)
{
  ...
  if (params_->use_collision_detection && collision_checker_->isCollisionImminent(pose, linear_vel, angular_vel, carrot_dist)) {
    throw nav2_core::ControllerException("DynamicWindowPurePursuitController detected collision ahead!");
  }
